...
export function buildingCost(p: PlayerState, kind: BuildingKind, rules: Ruleset): number {
...
export function addBuilding(p: PlayerState, kind: BuildingKind, rules: Ruleset): void {
...
export const PLAYER_COLORS = [
  0xe0a83c, 0x5bc98c, 0x5aa9e0, 0xe0605f, 0xb07ce0, 0x40c9c9, 0xe08a5a, 0x9aa3b2,
] as const
...
export function takenColors(players: PlayerState[], index: number): Set<number> {
...
export function freeColor(players: PlayerState[], index: number, preferred: number): number {
...
export function nextFreeColor(taken: Set<number>, from: number, dir: number): number {
  let i = from
...
export function playerNameError(name: string, taken: string[]): "empty" | "taken" | null {
...
export function createGameState(count: number, rules: Ruleset = "atari"): GameState {
